...
impl From<cli::TargetSelectionArgs> for build::TargetSelection {
    fn from(args: cli::TargetSelectionArgs) -> Self {
        Self {
            named_bins: args.named_bins,
            named_tests: args.named_tests,
            named_benches: args.named_benches,
            named_examples: args.named_examples,
            lib: args.lib,
            bins: args.bins,
            tests: args.tests,
        ...
        command => {
            ...
            match command {
                ...
                cli::Command::Run(args) => run_build(
                    ...
                    false,
                    build::Mode::Run,
                    cli::TargetSelectionArgs {
                        named_bins: args.bin.into_iter().collect(),
                        named_examples: args.example.into_iter().collect(),
                        ..Default::default()
                    },
                    Vec::new(),
                    false,
